...
const options = ["Details2080", "IRDCBMS2080", "Details", "Summery", "IRDCBMS"];
...
const PurchaseBookGrid = () => {
  const PrintComponent = () => {
    ...
    const getPurchaseData = async () => {
      try {
        const purchaseData: IGetAllPurchase[] = await getAllPurchaseBook(
          dateValue,
          Name
        );
      ...
      <>
        ...
        >
          <Grid
            ...
            container
          >
            <Typography variant="h6">Purchase Book</Typography>
          </Grid>
            ...
            <Grid item lg={12} xl={4}>
              ...
              >
                ...
                >
                  ...
                  />
                  <ExcelBtn fileName="PurchaseBook" />
                </ButtonGroup>
              </Box>
            </Grid>
          </Grid>
