...
import { InitialJournalData } from "./InitialJournalData";

const JournalViewContent = () => {
  const { id }: IParams = useParams();
  const [accountHolder, setAccountHolder] = useState<ISelectType[]>([]);
  const [voucherData, setVoucherData] = useState(InitialJournalData);
  ...
  return (
    <>
      ...
      >
        <ViewHeader name="Journal Voucher" />
        <Box
          sx={{
            mt: 3,
            px: 5,
            ...
            <Table>
              ...
              <TableBody>
                    ...
                    return (
                      <>
                        <TableRow>
                          ...
                          <TableCell align="right">
                            {value.Credit && value.Credit.toFixed(2)}
                          </TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell align="right">
                    {voucherData.CreditAmount &&
                      voucherData.CreditAmount.toFixed(2)}
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell colSpan={5}>
...
export default JournalViewContent;
