...
const ManageOrdermanagement = () => {
  const ormg = useAppSelector((state) => state.ormgData.data);
  ...
  const loadData = async () => {
    if(loginedUserRole.includes("OMAdd") && id === "add"){
    ...
    else if(loginedUserRole.includes("OMEdit") && id !== "add") {
      try {
...
export default ManageOrdermanagement;
