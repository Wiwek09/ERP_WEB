...
const MasterLedgerTable = ({allData}:any) => { 
    return (
        <>
                ...
                <Table stickyHeader id="downloadExcel">
                    <TableHead>
                        <TableRow sx={{ bgcolor: "primary.tableHeader" }}>
                            ...
                            <TableCell>UnderGroup Master</TableCell>
                         ...
                         allData.map((elm:any, i:number) => {
                            return(
                                <TableRow sx={{ bgcolor: "primary.tableHeader" }}>
                                    ...
                                    <TableCell>{elm.UnderGroupMaster}</TableCell>
                                    <TableCell>{elm.BranchId}</TableCell>
...
export default MasterLedgerTable;
